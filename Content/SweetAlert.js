...
{
 "use strict";
 var Global,Samples,HelloWorld,WebSharper,Operators,Obj,UI,Var$1,Doc,Promise,Var,ConcreteVar,Snap,Array,Client,Templates,JavaScript,Pervasives,Abbrev,Fresh,View,Arrays,List,T,Unchecked,Object,DomUtility,EventTarget,Node,JS,Collections,Dictionary,AttrProxy,DocElemNode,CharacterData,Enumerator,SC$1,HashSet,Seq,WindowOrWorkerGlobalScope,SC$2,Docs,Elt,T$1,SC$3,Attrs,Dyn,DictionaryUtil,Prepare,Slice,KeyCollection,An,Settings,Mailbox,Updates,Attrs$1,Strings,Docs$1,RunState,NodeSet,Anims,SC$4,SC$5,SC$6,Concurrency,AppendList,HashSetUtil,Queue,Easing,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 {
  var WelcomeBox,r,WarningBox,r$1,ErrorBox,r$2,InfoBox,r$3,QuestionBox,r$4,r$5,WarningButton,ErrorButton,InfoButton,QuestionButton,a;
  WelcomeBox=(r={},r.titleText="Welcome!",r.text="Welcome to my snippet! Here you will witness various features of SweetAlert",r.type="success",r);
  WarningBox=(r$1={},r$1.titleText="Warning!",r$1.text="This is a warning type box, with a cancel button",r$1.type="warning",r$1.allowOutsideClick=false,r$1.showCancelButton=true,r$1);
  ErrorBox=(r$2={},r$2.titleText="Error!",r$2.text="This is an error type box, with custom button color",r$2.type="error",r$2.confirmButtonColor="#BB0000",r$2);
  InfoBox=(r$3={},r$3.titleText="Information",r$3.text="This is an info type box, with a custon background color",r$3.type="info",r$3.background="#dff",r$3);
  QuestionBox=(r$4={},r$4.titleText="Question Box",r$4.text="Type something into the input field, and let's see what happens!",r$4.type="question",r$4.input="text",r$4.confirmButtonText="Send",r$4);
  r$5=Global.Sweetalert2(WelcomeBox);
  WarningButton=Doc.Button("Warning",[],function()
  {
   var r$6;
   r$6=Global.Sweetalert2(WarningBox);
  });
  ErrorButton=Doc.Button("Error",[],function()
  {
   var r$6;
   r$6=Global.Sweetalert2(ErrorBox);
  });
  InfoButton=Doc.Button("Info",[],function()
  {
   var r$6;
   r$6=Global.Sweetalert2(InfoBox);
  });
  Var$1.Create$1("");
  QuestionButton=Doc.Button("Click me!",[],function()
  {
   var r$6;
   (r$6=Global.Sweetalert2(QuestionBox),r$6).then(function(input)
   {
    var r$7,r$8;
    r$7=Global.Sweetalert2((r$8={},r$8.titleText="Result",r$8.text="You wrote: "+input,r$8.type="info",r$8)),r$7;
   });
  });
  a=Doc.Concat([Doc.Element("h1",[],[Doc.TextNode("WebSharper.SweetAlert")]),Doc.Element("p",[],[Doc.TextNode("You have already seen the success box, now let's have a look at the other basic box types:")]),Doc.Element("ul",[],[Doc.Element("li",[],[WarningButton]),Doc.Element("li",[],[ErrorButton]),Doc.Element("li",[],[InfoButton])]),Doc.Element("p",[],[Doc.TextNode("Now, let's see the question type button, with a much more interesting example:")]),Doc.Element("br",[],[]),QuestionButton]);
 ...
 ConcreteVar=UI.ConcreteVar=Runtime.Class({},Var,ConcreteVar);
